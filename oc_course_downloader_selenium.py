...
class OcCourseFetcher(object):
    name = 'oc-course-fetcher'
    # allowed_domains = ['https://openclassrooms.com/fr/courses/4011851-initiez-vous-au-machine-learning/5868296-transformez-des-besoins-metiers-en-problemes-de-machine-learning']
    # start_urls = ['http://https://openclassrooms.com/fr/courses/4011851-initiez-vous-au-machine-learning/5868296-transformez-des-besoins-metiers-en-problemes-de-machine-learning/']
    # we want to dynamically adjust the start page
    # allowed_domains = []
    # start_urls = []
    ...
    def __init__(self):
        super(OcCourseFetcher, self).__init__()
    
    def new_request(self, url, callback):
        return scrapy.Request(url=url, callback=self.parseYearResultsPage)
    
    def extract_course_chapters(self, html_page, course_url):
        ...
        course_id, course_chapter_subpath, lang = self._helper_parse_course_page_url(course_url)
    ...
    def parse_course_page_content(self, html_page, driver=None, verbose=1):
        """
        ...
        for i, tag in enumerate(image_tags):
            ...
            course_id, course_page, lang = self._helper_parse_course_page_url(url)
        ...
        ### getting video infos
        # look for an iframe with src pointing to vimeo player. Like
    ...
    def _helper_parse_course_page_url(self, url):
        """
        Example of urls:
